  ...
  return (
    ...
    >
              ...
              {query.length ? (
                ...
                <div className="textResult h-16">
                  ...
                  {match?.name ? (
                    ...
                    <div
                      className="smatch flex my-2 p-3 rounded"
                    >
      ...
      {showPasswordDialog && (
        ...
        <div
          className="passwordDialogOverlay"
          onMouseDown={(event) => {
        ...
        >
          ...
          >
            ...
            <div className="passwordDialogHeader">

              <div className="passwordDialogTitle">
                修改密码
              </div>

              <button
                type="button"
                className="passwordDialogClose"
                onClick={
                  closePasswordDialog
                }
                disabled={
            ...
            >
              ...
              <div className="passwordDialogBody">
              ...
              <div className="passwordDialogFooter">
